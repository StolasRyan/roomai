...
const {id} = useParams();
  ...
  const handleExport = ()=>{
    ...
    link.download = `roomai-${id || 'design'}.png`;
  ...
  return (
    <div className="visualizer">
        <nav className="topbar">
            ...
            <Button variant="ghost" className="exit" size="sm" onClick={handleBack}>
                ...
                {isProcessing && (
                    <div className="render-overlay">
                        <div className="rendering-card">
                            ...
                            <span className="subtitle">Generating youre 3D visualization...</span>
                        </div>
                    </div>
                )}
            </div>
